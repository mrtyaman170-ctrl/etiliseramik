    ...
    <div class="modal work-detail-modal">
      <div class="modal-head">
        <div>
          ...
          ${!isRequest&&item.outsourcedRequired?'<b class="outsource-badge">TAŞERONA VERİLECEK</b>':""}
      ...
      ${isRequest&&canManageWorkRequest(item)&&!["converted","rejected","cancelled","done"].includes(item.status)?`<section class="work-detail-decision">
        ...
        <div class="work-detail-decision-actions">
          ...
          <button type="button" data-work-request-action="outsource" data-work-id="${esc(item.id)}" class="outsource-action">Taşerona Verilecek Olarak İş Emrine Dönüştür</button>
        </div>
      </section>`:""}
